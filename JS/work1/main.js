...
// document.write('<h2>' + number5 + '</h2>');
// document.write('<h2>' + number6 + '</h2>');
// document.write('<h2>' + number7 + '</h2>');
...
// let midleName = prompt('set your midle name')
// let space = ' ';
//
// console.log(surname);
// console.log(name);
...
// let num2 = prompt('set second number');
// let num3 = prompt('set third number');
// let num4 = prompt('set fourth number');
//
// num1 = parseInt(num1);
// num2 = parseInt(num2);
// num3 = parseInt(num3);
...
// console.log((111 > 11 || 45 < 111) && (132 > 100 || 45 < 12) ); // F
